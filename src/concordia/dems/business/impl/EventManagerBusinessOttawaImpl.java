...
public class EventManagerBusinessOttawaImpl implements IEventManagerBusiness {
    ...
    */
    ...
    @Override
    public String addEvent(String addEventInfo) {
    ...
    @Override
    public String removeEvent(String removeEventInfo) {
    ...
    */
    ...
    @Override
    public String bookEvent(String eventBookingInfo) {
    ...
    @Override
    public String cancelEvent(String cancelEventInfo) {
